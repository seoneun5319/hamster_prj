...
String name="이장훈";
%>
<!-- HTML 주석 : JSP > java > class >instance > HTML로 만들어진다. -->
HTML 주석 : <!-- <%= name %> --><br>
<!-- HTML 주석 : JSP > java > class에 포함되지 않는다. >instance 생성 x > HTML로 만들어지지 않는다. -->
Java 주석 : <%= /*이것은 이름변수 입니다.*/ name %> <br>
<!-- JSP 주석 : JSP > java에 포함 x> class에 포함 x >instance 생성x > HTML로 만들어지지 않는다. -->
JSP 주석 : <%-- <%= name %> --%>
