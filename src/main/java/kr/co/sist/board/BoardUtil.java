...
public class BoardUtil {
	 ...
	 * totalPage - 게시글의 총 페이지 수
	 * url - 이동할 url, field - 검색 필드(제목,내용,작성자)
	 * keyword - 검색 키워드를 pDTO로 입력 받아서 <br>
	...
	public static String pagination(PaginationDTO pDTO) {		
		...
		int movePage=0;
		StringBuilder prevMark=new StringBuilder("[ <span class= 'pagiNextMark'>&lt;&lt;</span> ]");
		if( pDTO.getCurrentPage() > pDTO.getPageNumber()){//시작페이지보다 1 적은 페이지로 이동
