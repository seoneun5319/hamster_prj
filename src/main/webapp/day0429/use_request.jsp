...
<style type="text/css">
 ...
 a{text-decoration: none; font-color:#333}
...
<input type="hidden" name="name" value="test222"/><!-- 고정된 값을 던져야 할때는 hidden을 사용 -->
<input type="hidden" name="age" value="20222"/>
<input type="button" name="post" value="POST방식의 요청" id="btn"/>
</form>
</div>
